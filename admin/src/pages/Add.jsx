    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
                ...
                <input onChange={(e)=>setPrice(e.target.value)} className='w-full px-3 py-2 sm:w-[120px]' type="number" value={price} placeholder='25'/>
            </div>
        </div>
        <div>
            <p className='mb-2' onChange={(e)=>setName(e.target.value)} value={name}>Product Sizes</p>
